import { JewelryItem, ContactInfo } from '../types';

export const JEWELRY_DATA: JewelryItem[] = [
  {
    id: '1',
    name: 'Temple Motif Jhumkas',
    category: 'Jhumkas',
    price: '₹850',
...
export const CONTACT_INFO: ContactInfo = {
  ...
  email: 'viraasat.oxidised@gmail.com',
  instagram: '@viraasat_oxidised',
  address: 'Heritage Market, Jaipur, Rajasthan, India'
};
